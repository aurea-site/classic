...
self.addEventListener('fetch',e=>{
 ...
 e.respondWith(caches.match(e.request).then(r=>r||fetch(e.request).then(n=>{const copy=n.clone();caches.open(C).then(c=>c.put(e.request,copy));return n})));
});
